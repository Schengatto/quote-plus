        ...
        <AppLayout>
            <div className="m-2 xl:m-8">
                <div className="page-title">
                    <span className="capitalize">{t("templates.table.title")}</span>
                </div>
                {!isInputFormActive
                    ?
                    ...
                    <div className="card mb-8">
                        <div className="font-semibold first-letter:capitalize">
                            {selectedTemplate?.id
                                ? <><span className="mr-1">{t("common.edit")}:</span>{templates.find(b => b.id === selectedTemplate.id)?.name}</>
                                : t("templates.button.addTemplate")
                            }
                        </div>
                        <div>
                            <form className="w-full" onSubmit={handleSave}>
                                <div className="w-full my-4">
                                    <div className="field-label">{t("templates.form.name")}</div>
                                    <input
                                        type="text"
                                ...
                                <div className='w-full my-4'>
                                    <div className='field-label'>{t("templates.form.content")}</div>
